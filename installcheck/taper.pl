...
SKIP : {
	...
	# note no "Will retry.."
	qr(^INFO taper tape TESTCONF01 PTAG00XX kb 832 fm 3 \[OK\]$),
	...
	qr(^INFO taper tape TESTCONF02 PTAG01XX kb 736 fm 3 \[OK\]$),
	...
	qr(^INFO taper tape TESTCONF02 PTAG01XX kb 800 fm 2 \[OK\]$),
